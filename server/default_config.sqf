...
A3W_spawnBeaconSpawnHeight = 1000; // Altitude in meters at which players will spawn when using spawn beacons (0 = ground/sea)
...
// Player settings
A3W_startingMoney = 200;           // Amount of money that players start with
...
A3W_buildingLootChances = 30;      // Chance percentage that loot will spawn at each spot in a building (0 to 100)
